...
public class TSRegistroSQL {
  ...
  public static final String updateRegistro = "UPDATE " + RegistroModelDM.TABLE_NAME + " SET id = ?, nome = ?, descrizione = ?, consegna = ?, confermaTutorAcc = ?, confermaTutorAz = ? WHERE id = ?;";
